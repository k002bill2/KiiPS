...
1. 다음을 읽어라:
   - PAGE_SPEC.md (설계서)
   - .Codex/agents/shared/kiips-evaluation-criteria.md (평가 기준)
...
4. .Codex/agents/shared/kiips-evaluation-criteria.md를 읽어라 (평가 기준).
...
## 검수 절차
1. .Codex/agents/shared/kiips-evaluation-criteria.md를 읽어라 (채점 기준).
