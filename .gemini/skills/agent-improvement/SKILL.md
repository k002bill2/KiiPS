...
```json
{
  ...
  "examples": [
    {
      "session_id": "sess_abc",
      "file": "FdFundController.java",
      "issue": "Missing @Transactional on service method"
    }
  ],
...
- Impact: 25% rework
- Pattern: Compilation errors on first integration
- Fix: Add pre-integration compile check
```
...
- Run 3: 컴파일 에러 (grader: java_compiles FAIL)
...
- Rubrics: [../../evals/rubrics/](../../evals/rubrics/) (if available)
- Task Definitions: [../../evals/tasks/](../../evals/tasks/) (if available)
