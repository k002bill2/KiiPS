...
#claude-code #ai-coding #development #guide #kiips

> 작성일: 2025-12-28 (최종 업데이트)
> 환경: macOS (Antigravity), Git, 단독 개발, KiiPS 프로젝트
> Claude Code 경험: 초보자 ~ 중급자용

## 📌 개요

Claude Code는 Anthropic이 개발한 터미널 기반 AI 코딩 도구로, 2025년 현재 가장 강력한 AI 개발 어시스턴트 중 하나입니다. 이 가이드는 **macOS 환경(Antigravity 포함)**에서 Claude Code를 시작하는 개발자를 위한 완벽한 설정 및 활용 가이드입니다.
...
# 버전 확인 (현재 최신: v2.0.76, 최소 v2.0.28 이상 권장)
claude --version
...
model: sonnet-4.5  # 또는 'inherit', 'opus-4.5', 'haiku-4.5'
---
...
|------|------|------|------|------|--------|
| **Haiku 4.5** | Claude | 간단한 작업, 빠른 반복 | 🚀🚀🚀 | 💰 | 2025.10.15 |
| **Sonnet 4.5** | Claude | 일반 개발, 코딩, 에이전트 | 🚀🚀 | 💰💰 | 2025.09.29 |
| **Opus 4.5** | Claude | 복잡한 추론, 엔터프라이즈 | 🚀 | 💰💰💰 | **2025.11.01** |
| **Skills** | | | | | |
...
### 2025년 12월 기준 주요 업데이트
- **Claude Code CLI**: v2.0.76 (최신) - LSP 도구, 다양한 터미널 지원 추가
- **Claude 3.5 Sonnet**: 2024.06.20 첫 출시, 2024.10.22 업그레이드 버전
- **Claude Sonnet 4.5** (`claude-sonnet-4-5-20250929`): 2025.09.29 출시 - 코딩, 에이전트, 컴퓨터 사용에 최적화
- **Claude Haiku 4.5** (`claude-haiku-4-5-20251015`): 2025.10.15 출시 - 저지연, 비용 효율적
- **Claude Opus 4.5** (`claude-opus-4-5-20251101`): **2025.11.01 출시** - 가장 지능적인 플래그십 모델
...
- **Programmatic Tool Calling**: 코드 기반 도구 오케스트레이션 (2025.11)
