...
### 파일 위치
`.claude/skills/kiips-*/SKILL.md`

### 1. KiiPS Maven Builder Skill
...
### 2. KiiPS Service Deployer Skill
...
### 3. KiiPS API Gateway Tester Skill
...
\`\`\`bash
# Call service directly (for testing)
...
- [ ] Service responds within SLA (<200ms)
...
*마지막 업데이트: 2025-12-28*
*태그: #claude-code #skills #examples #automation #kiips #enterprise*