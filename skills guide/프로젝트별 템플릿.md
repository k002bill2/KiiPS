...
### CLAUDE.md 템플릿
**위치**: [CLAUDE.md 템플릿.md](./CLAUDE.md%20템플릿.md#kiips-프로젝트-예시)
- KiiPS 마이크로서비스 아키텍처
- Maven Multi-Module 빌드 규칙
- 환경별 설정 관리
- API Gateway 패턴

### Skills 템플릿
**위치**: [Agent Skills 예시 모음.md](./Agent%20Skills%20예시%20모음.md#kiips-엔터프라이즈-skills)
- kiips-maven-builder
...
### Hook 설정 템플릿
**위치**: [Skills 자동 활성화 시스템.md](./Skills%20자동%20활성화%20시스템.md#kiips-프로젝트-hook-예시)
- Maven Build 자동화
...
*마지막 업데이트: 2025-12-28, 환경: macOS (Antigravity 호환)*
*KiiPS 엔터프라이즈 템플릿 추가*

#templates #project-setup #claude-code #kiips #enterprise