> ⚠️ **ARCHIVED (2026-07-31)**: 구버전(2026-03) 수동 디렉토리 방식으로, Power Stack 가이드 문서(2026-07-15)가 스스로 obsolete 선언. 현재는 superpowers/gsd 스킬 팩이 대체. 규칙 효력 없음 — 기록 보존용.
...
- 코드 구현이 완료되면, 'QA 리드' 페르소나로 전환하여 사용자 관점의 엣지 케이스(Edge Case)를 테스트하고 교차 검증을 받습니다.
